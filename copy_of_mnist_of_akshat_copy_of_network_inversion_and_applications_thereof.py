# -*- coding: utf-8 -*-
"""Copy of MNIST of Akshat_Copy_of_Network_Inversion_and_Applications_Thereof.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wcSX1c4aNrx9aNofGh2KevxO6exEqsj6
"""
...
# Define the specific epochs where you want to save images
selected_epochs = [1, 200, 500, 1000, 2000]

# Dictionary to store generated images for selected epochs
generated_images = {}
...
for epoch in range(num_epochs):
    ...
    loss = (
        ...
        + 1 * orthogonality_loss
        + 3000 * cross_entropy
        + 1 * kl_divergence_value
    ...
    # Save and store generated images at specific epochs
    if (epoch + 1) in selected_epochs:
        with torch.no_grad():
            ...
            generated_images[epoch + 1] = fixed_gen_images  # Store the generated images
...
# Print the accuracies at the selected epochs
print("\nAccuracy at selected epochs:")
for epoch in selected_epochs:
    accuracy_at_epoch = accuracies[epoch - 1]  # Subtract 1 for zero-based indexing
    print(f"Epoch {epoch}: Accuracy = {accuracy_at_epoch:.4f}")

# Display the stored images at the selected epochs
for epoch in selected_epochs:
    print(f"Displaying images generated at Epoch {epoch}:")
    display_inline_image(generated_images[epoch])
